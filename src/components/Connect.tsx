          ...
          <div className="flex justify-center lg:gap-6 gap-2">
            {secondarySocials.map((item) => (
              <a
                ...
                className="flex items-center gap-2 lg:px-5 lg:py-2.5 px-3 py-2 bg-white/5 border border-white/10 rounded-2xl text-slate-400 text-sm font-medium hover:text-white hover:bg-white/10 hover:border-white/20 hover:-translate-y-0.5 transition-all duration-300"
              >
                {item.icon}
                {item.label}
              </a>
